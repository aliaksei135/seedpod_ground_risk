...
class StrikeModelTestCase(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.pix_area = 20 * 20
        self.test_pdf = np.random.random(self.test_shape) * 2
    ...
    def test_max_range(self):
        ...
        sm = StrikeModel(max_grid, self.pix_area, np.deg2rad(30), 2)
    ...
    def test_min_range(self):
        ...
        sm = StrikeModel(min_grid, self.pix_area, np.deg2rad(30), 2)
